...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in sllm_store/proto/storage_pb2_grpc.py depends on'
...
class StorageStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ConfirmModel = channel.unary_unary(
                ...
                _registered_method=True)
        self.ConfirmGpuGroup = channel.unary_unary(
                '/storage.Storage/ConfirmGpuGroup',
                request_serializer=sllm__store_dot_proto_dot_storage__pb2.ConfirmGpuGroupRequest.SerializeToString,
                response_deserializer=sllm__store_dot_proto_dot_storage__pb2.ConfirmGpuGroupResponse.FromString,
                _registered_method=True)
...
class StorageServicer(object):
    ...
    def ConfirmGpuGroup(self, request, context):
        """############# SLLM-CONDENSE #########
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_StorageServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ConfirmGpuGroup': grpc.unary_unary_rpc_method_handler(
                    servicer.ConfirmGpuGroup,
                    request_deserializer=sllm__store_dot_proto_dot_storage__pb2.ConfirmGpuGroupRequest.FromString,
                    response_serializer=sllm__store_dot_proto_dot_storage__pb2.ConfirmGpuGroupResponse.SerializeToString,
            ),
...
class Storage(object):
    ...
    def ConfirmGpuGroup(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/storage.Storage/ConfirmGpuGroup',
            sllm__store_dot_proto_dot_storage__pb2.ConfirmGpuGroupRequest.SerializeToString,
            sllm__store_dot_proto_dot_storage__pb2.ConfirmGpuGroupResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
